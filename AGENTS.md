...
- In the share sheet, present the poster at a generous mobile width and scroll the tabs, complete poster, and action block as one continuous surface. Keep the actions after the poster rather than in a fixed footer or a separate nested-scroll layout, and never reserve empty feedback or fixed-height space below the buttons.
