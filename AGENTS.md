...
- Collect name, birth date, exact birth time, birthplace, and IANA time zone progressively in the drawer. Calculate through the dedicated Wendao Human Design JSON API, show only the result and interpretation, and never render or recreate a BodyGraph.
