# Wendao · App Store English metadata
...
- Marketing URL: `https://wendao.wonderelian.com/`
- Privacy policy URL: `https://wendao.wonderelian.com/privacy.html`
...
Wendao is a quiet, offline-friendly way to read the Daodejing. It uses Mawangdui Silk Manuscript B as its primary foundation and keeps three textual layers distinct: the Silk B transcription, an edited base reading, and modern interpretation. This makes damaged graphs, supplied characters, and references to received editions visible instead of silently blending them together.
