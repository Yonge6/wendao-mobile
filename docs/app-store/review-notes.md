...
Wendao is a bilingual Daodejing reading app. No login is required. All 81 chapters and the core reading interface are bundled locally and remain available offline.
...
4. Open More to inspect day/night mode, text size, sharing, About, and the optional Life Manual entry.

## 中文备份

三慢问道是一款中英文《道德经》阅读 App，无需登录。完整 81 章及核心阅读界面随 App 本地打包，可离线使用。
