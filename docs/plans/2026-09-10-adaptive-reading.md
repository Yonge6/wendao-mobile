...
4. Increment all iOS targets to 1.8 (18), sync the validated shared web bundle, archive and upload. Verify iPhone and iPad native launches and capture actual native screenshots in both languages. Do not fabricate an iPhone Duo screenshot or claim device validation without an official runtime/device.
5. Publish and verify the matching H5 artifact. Preserve rollback artifacts.
6. Once build 18 is processed and replacement materials are ready, remove build 17's waiting submission, update both locales and reviewer notes with all unpublished 1.8 changes plus adaptive reading, select 18, and submit. Verify the final Apple review state and automatic release selection.
